...
<head>
    ...
    <meta name="keywords" content="开奖管理">
    <meta name="description" content="开奖管理">
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_1").jqGrid({
            ...
            rowNum:10,
            rowList:[10,20,30],
            colNames:["单号","用户ID","采购号码","中奖状态"],
            colModel:[{name:"orderDetailId",index:"orderDetailId",editable:true,hidedlg:true}
                ,{name:"userId",index:"userId",editable:true}
                ,{name:"lotteryString",index:"lotteryString",editable:true}
                ,{name:"lotteryLevel",index:"lotteryLevel",editable:true}
